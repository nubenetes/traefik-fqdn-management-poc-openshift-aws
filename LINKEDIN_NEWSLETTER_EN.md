...
> [!NOTE]
> **Architectural & AI Notice:** This report and its companion repository were generated by **Gemini 3.8 Flash** as a theoretical architectural reference guide and PoC blueprint. They have not been validated in a live cluster environment. They serve as an adaptable template and starting foundation, particularly valuable for platform teams in **air-gapped environments** or organizations with **digital sovereignty restrictions** prohibiting external cloud AI tooling.
